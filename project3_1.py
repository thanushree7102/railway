...
# 📧 Email Credentials (App Passwords) from environment variables
EMAIL_CREDENTIALS = {
    "tshree4179@gmail.com": os.getenv("EMAIL_PASS1"),
    "vis12356789@gmail.com": os.getenv("EMAIL_PASS2"),
    "sphalguna17@gmail.com": os.getenv("EMAIL_PASS3"),
    "mohitv9110@gmail.com": os.getenv("EMAIL_PASS4"),
    "sn3951418@gmail.com": os.getenv("EMAIL_PASS5"),
    "manjushreemr18@gmail.com": os.getenv("EMAIL_PASS6")
}
...
def init_db():
    db_path = "complaints.db"  # Relative path
...
st.sidebar.image("thanu_image.jpg", width=250)  # Assuming the image is in the project directory
...
if choice == "File a Complaint":
    ...
    if input_method == "Record/Upload Audio":
        ...
        with col1:
            # Only show recording option if running locally (not on Streamlit Cloud)
            if platform.system() != "Linux" or "streamlit" not in os.environ.get("SERVER_SOFTWARE", ""):
                ...
                st.info("ℹ Audio recording is disabled in this environment.")
